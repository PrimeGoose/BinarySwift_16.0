 ...
 */
public struct BinaryData: ExpressibleByArrayLiteral, Sendable {
   ...
   */
  public func get(_ offset: Int, bigEndian _: Bool? = nil) throws -> UInt8 {
  ...
  public func getNullTerminatedUTF8(_ offset: Int) throws -> String {
    ...
    while true {
      ...
      case let .scalarValue(unicodeScalar) where unicodeScalar.value > 0:
        string.append(String(unicodeScalar))
      case .scalarValue: // \0 means end of string
        return string
      case .emptyInput:
  ...
  public func getUTF8(_ offset: Int, length: Int) throws -> String {
    ...
    while true {
      switch utf8.decode(&generator) {
      case let .scalarValue(unicodeScalar):
        string.append(String(unicodeScalar))
      case .emptyInput:
        return string
      case .error:
